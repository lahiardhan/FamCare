...
const AddDiscussion = () => {
  ...
  return (
    <form onSubmit={submitHandler}>
      <div class="mb-6">
        <label htmlFor="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
          Masukkan Judul
        </label>
        <input
          type="text"
      ...
      <div class="mb-6">
        <label htmlFor="content" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
          Masukan diskusi
        </label>
        <input
          type="text"
