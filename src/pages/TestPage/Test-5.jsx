      ...
      <div className='flex justify-center mt-32 xs:hidden'>
        <div className='flex flex-col container px-5'>
          <div className='flex mt-11 ml-8'>
            <p className='text-left text-lg font-semibold opacity-60 color-black'>5/14</p>
          </div>
          <div className='flex flex-col mt-4'>
            <div className='flex justify-center mt-14'>
              <div className='w-[180px] h-[220px] border-solid border-black border-4 rounded-t-full'>
                <div className='flex justify-center mt-14'>
                  <img src='images/test-images/test5-images.svg' className='w-[150px]'/>
                </div>
              </div>
            </div>       
            <div className='flex justify-center mt-12'>
              <h2 className='text-center text-2xl font-bold uppercase w-[800px]'>Gangguan Kecerdasan</h2>
            </div>
            <div className='flex justify-center mt-6'>
              <p className='text-center text-base font-medium w-[850px]'>“ Seberapa besar anda sedang mengalami gejala seperti sukar berkonsentrasi, daya ingat buruk, daya ingat menurun untuk saat ini ? “
              </p>
            </div>
          ...
          <div className='flex flex-row justify-center mt-24'>
            <div className=''>
              <Button text='Sebelumnya' link='/test4'/>
            </div>
            <div className='ml-[141px]'>
              <Button text='Selanjutnya' link='/test6'/>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='hidden md:flex justify-center mt-32 lg:hidden'>
        <div className='flex flex-col container px-5'>
          ...
          <div className='flex flex-col mt-4'>
            ...
            <div className='flex justify-center mt-12'>
              <h2 className='text-center text-3xl font-bold uppercase w-[800px]'>Gangguan Kecerdasan</h2>
            </div>
            <div className='flex justify-center mt-6'>
              <p className='text-center text-lg font-medium w-[850px]'>“ Seberapa besar anda sedang mengalami gejala seperti sukar berkonsentrasi, daya ingat buruk, daya ingat menurun untuk saat ini ? “
              </p>
            </div>
            <div className='flex justify-center mt-[50px]'>
              <ButtonSlider />
