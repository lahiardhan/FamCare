  ...
  if (loading) {
    return (
      <section className="min-h-screen pt-20">
        <div>
          <h1 className="font-extrabold text-4xl mt-4 lg:py-7 text-center">Artikel FamCare</h1>
        </div>
    ...
    <>
      <section className="min-h-screen pt-20">
        ...
        {articles.length !== 0 ? (
          ...
          <div className="flex flex-col justify-center items-center h-[83vh]">something went wrong</div>
        )}
      </section>
      <Footer />
    </>
